...
//			motions.push(animation.fromMotion3Json(resources['motion9'].data));
		...
		var p1 = new Promise(function (resolve, reject) {
			...
			loader.add('model3', "assets/ninzin/ninzin.model3.json", xhrType);
			loader.add('motion1', "assets/ninzin/ninzin01.motion3.json", xhrType);
			loader.add('motion2', "assets/ninzin/ninzin02.motion3.json", xhrType);
